...
import time
import iiotest_epy_block_0 as epy_block_0  # embedded python block
import iiotest_epy_block_1 as epy_block_1  # embedded python block
import osmosdr
...
class iiotest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "iiotest")
...
def main(top_block_cls=iiotest, options=None):
